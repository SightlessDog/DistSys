...
public final class SortServer implements Runnable, AutoCloseable {
    ...
    static private Runnable newConnectionHandler (final Socket connection) throws NullPointerException {
        ...
        return () -> {
            ...
            // Read all char source lines until you reach a null or empty line, and
    ...
    static public void main (final String[] args) throws IOException {
        ...
        try (edu.sb.ds.sort.SortServerSkeleton server = new edu.sb.ds.sort.SortServerSkeleton(servicePort)) {
